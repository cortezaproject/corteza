...
func TestModuleLabels(t *testing.T) {
	...
	t.Run("create", func(t *testing.T) {
		...
		helpers.SetLabelsViaAPI(h.apiInit(), t,
			...
			types.Module{Labels: map[string]labelTypes.LabelValue{"foo": {Val: "bar"}, "bar": {Val: "42"}}},
			payload,
		)
	...
	t.Run("update", func(t *testing.T) {
		...
		helpers.SetLabelsViaAPI(h.apiInit(), t,
			...
			types.Module{Labels: map[string]labelTypes.LabelValue{"foo": {Val: "baz"}, "baz": {Val: "123"}}},
			payload,
		)
		req.NotZero(payload.ID)
	...
	t.Run("field create", func(t *testing.T) {
		...
		mod.Fields = append(mod.Fields, &types.ModuleField{
			...
			Name:   "labeled",
			Label:  "",
			Labels: map[string]labelTypes.LabelValue{"fldfoo": {Val: "fldbar"}},
		})
	...
	t.Run("field update", func(t *testing.T) {
		...
		mod.Fields = append(mod.Fields, &types.ModuleField{
			...
			Name:   "labeled",
			Label:  "",
			Labels: map[string]labelTypes.LabelValue{"fldfoo": {Val: "fldbaz"}},
		})
