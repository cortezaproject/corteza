...
var (
	...
	_ store.City311Constituents        = &Store{}
...
// CreateCity311Constituent creates one or more rows in city311Constituent collection
//
// This function is auto-generated
func (s *Store) CreateCity311Constituent(ctx context.Context, rr ...*composeType.City311Constituent) (err error) {
	for i := range rr {
		if err = s.checkCity311ConstituentConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311ConstituentInsertQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpdateCity311Constituent updates one or more existing entries in city311Constituent collection
//
// This function is auto-generated
func (s *Store) UpdateCity311Constituent(ctx context.Context, rr ...*composeType.City311Constituent) (err error) {
	for i := range rr {
		if err = s.checkCity311ConstituentConstraints(ctx, rr[i]); err != nil {
			return
		}

		if err = s.Exec(ctx, city311ConstituentUpdateQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpsertCity311Constituent updates one or more existing entries in city311Constituent collection
//
// This function is auto-generated
func (s *Store) UpsertCity311Constituent(ctx context.Context, rr ...*composeType.City311Constituent) (err error) {
	for i := range rr {
		if err = s.checkCity311ConstituentConstraints(ctx, rr[i]); err != nil {
			return
		}
		...
		if s.Dialect.Nuances().TwoStepUpsert {
			var rsp sql.Result
			rsp, err = s.ExecR(ctx, city311ConstituentUpdateQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
			if c, err := rsp.RowsAffected(); err != nil {
			...
			err = s.Exec(ctx, city311ConstituentInsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		} else {
			err = s.Exec(ctx, city311ConstituentUpsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		}
...
// DeleteCity311Constituent Deletes one or more entries from city311Constituent collection
//
// This function is auto-generated
func (s *Store) DeleteCity311Constituent(ctx context.Context, rr ...*composeType.City311Constituent) (err error) {
	for i := range rr {
		if err = s.Exec(ctx, city311ConstituentDeleteQuery(s.Dialect.GOQU(), city311ConstituentPrimaryKeys(rr[i]))); err != nil {
			return
		}
	}
...
// DeleteCity311ConstituentByID deletes single entry from city311Constituent collection
//
// This function is auto-generated
func (s *Store) DeleteCity311ConstituentByID(ctx context.Context, id uint64) error {
	return s.Exec(ctx, city311ConstituentDeleteQuery(s.Dialect.GOQU(), goqu.Ex{
		"id": id,
	}))
}

// TruncateCity311Constituents Deletes all rows from the city311Constituent collection
func (s *Store) TruncateCity311Constituents(ctx context.Context) error {
	return s.Exec(ctx, city311ConstituentTruncateQuery(s.Dialect.GOQU()))
}

// SearchCity311Constituents returns (filtered) set of City311Constituents
//
// This function is auto-generated
func (s *Store) SearchCity311Constituents(ctx context.Context, f composeType.City311ConstituentFilter) (set composeType.City311ConstituentSet, _ composeType.City311ConstituentFilter, err error) {
	...
	// Cloned sorting instructions for the actual sorting
	// Original are passed to the etchFullPageOfCity311Constituents fn used for cursor creation;
	// direction information it MUST keep the initial
	sort := f.Sort.Clone()
	...
	set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfCity311Constituents(ctx, f, sort)
	...
	if f.IncTotal {
		...
		if f.Limit > 0 && uint(len(set)) == f.Limit {
			...
			limit := f.Limit
			f.Limit = 0
			var navSet composeType.City311ConstituentSet
			if navSet, _, _, err = s.fetchFullPageOfCity311Constituents(ctx, f, sort); err != nil {
				return
			} else {
				f.Total = uint(len(navSet))
				f.Limit = limit
...
// fetchFullPageOfCity311Constituents collects all requested results.
//
// Function applies:
//   - cursor conditions (where ...)
//   - limit
...
//
// This function is auto-generated
func (s *Store) fetchFullPageOfCity311Constituents(
	ctx context.Context,
	filter composeType.City311ConstituentFilter,
	sort filter.SortExprSet,
) (set []*composeType.City311Constituent, prev, next *filter.PagingCursor, err error) {
	var (
		aux []*composeType.City311Constituent
		...
		tryFilter composeType.City311ConstituentFilter
	)

	set = make([]*composeType.City311Constituent, 0, DefaultSliceCapacity)
	...
	for try := 0; try < MaxRefetches; try++ {
		...
		if aux, hasNext, err = s.QueryCity311Constituents(ctx, tryFilter); err != nil {
			return nil, nil, nil, err
		}
		...
		if reqItems > collected {
			...
			// Update cursor so that it points to the last item fetched
			tryFilter.PageCursor = s.collectCity311ConstituentCursorValues(set[collected-1], filter.Sort...)
	...
	if hasPrev {
		prev = s.collectCity311ConstituentCursorValues(set[0], filter.Sort...)
		prev.ROrder = true
		prev.LThen = !filter.Sort.Reversed()
	}

	if hasNext {
		next = s.collectCity311ConstituentCursorValues(set[collected-1], filter.Sort...)
		next.LThen = filter.Sort.Reversed()
	}
...
// QueryCity311Constituents queries the database, converts and checks each row and returns collected set
//
// With generics, we can remove this per-resource-generated function
// and replace it with a single utility fetcher
//
// This function is auto-generated
func (s *Store) QueryCity311Constituents(
	ctx context.Context,
	f composeType.City311ConstituentFilter,
) (_ []*composeType.City311Constituent, more bool, err error) {
	var (
		ok bool

		set         = make([]*composeType.City311Constituent, 0, DefaultSliceCapacity)
		res         *composeType.City311Constituent
		aux         *auxCity311Constituent
		rows        *sql.Rows
		count       uint
		expr, tExpr []goqu.Expression
	...
	if s.Filters.City311Constituent != nil {
		// extended filter set
		tExpr, f, err = s.Filters.City311Constituent(s, f)
	} else {
		// using generated filter
		tExpr, f, err = City311ConstituentFilter(s.Dialect, f)
	}

	if err != nil {
		err = fmt.Errorf("could not generate filter expression for City311Constituent: %w", err)
		return
	}
	...
	// paging feature is enabled
	if f.PageCursor != nil {
		if tExpr, err = cursorWithSorting(f.PageCursor, s.sortableCity311ConstituentFields()); err != nil {
			return
		} else {
			expr = append(expr, tExpr...)
		}
	...
	query := city311ConstituentSelectQuery(s.Dialect.GOQU()).Where(expr...)

	// sorting feature is enabled
	if sortExpr, err = order(f.Sort, s.sortableCity311ConstituentFields()); err != nil {
		err = fmt.Errorf("could not generate order expression for City311Constituent: %w", err)
		return
	}
	...
	rows, err = s.Query(ctx, query)
	if err != nil {
		err = fmt.Errorf("could not query City311Constituent: %w", err)
		return
	}
	...
	for rows.Next() {
		...
		aux = new(auxCity311Constituent)
		if err = aux.scan(rows); err != nil {
			err = fmt.Errorf("could not scan rows for City311Constituent: %w", err)
			return
		}

		count++
		if res, err = aux.decode(); err != nil {
			err = fmt.Errorf("could not decode City311Constituent: %w", err)
			return
		}
...
//
// This function is auto-generated
func (s *Store) LookupCity311ConstituentByID(ctx context.Context, id uint64) (_ *composeType.City311Constituent, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311Constituent)
		lookup = city311ConstituentSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("id").Eq(id),
		).Limit(1)
	)
...
//
// This function is auto-generated
func (s *Store) LookupCity311ConstituentByConstituentID(ctx context.Context, constituentID string) (_ *composeType.City311Constituent, err error) {
	var (
		rows   *sql.Rows
		aux    = new(auxCity311Constituent)
		lookup = city311ConstituentSelectQuery(s.Dialect.GOQU()).Where(
			goqu.I("constituent_id").Eq(constituentID),
		).Limit(1)
	)
...
// sortableCity311ConstituentFields returns all <no value> columns flagged as sortable
//
// # Notes
// With optional string arg, all columns are returned aliased
//
// This function is auto-generated
func (Store) sortableCity311ConstituentFields() map[string]string {
	return map[string]string{
...
// collectCity311ConstituentCursorValues collects values from the given resource that and sets them to the cursor
// to be used for pagination
//
// Values that are collected must come from sortable, unique or primary columns/fields
// At least one of the collected columns must be flagged as unique, otherwise fn appends primary keys at the end
...
//
// This function is auto-generated
func (s *Store) collectCity311ConstituentCursorValues(res *composeType.City311Constituent, cc ...*filter.SortExpr) *filter.PagingCursor {
	var (
		cur = &filter.PagingCursor{LThen: filter.SortExprSet(cc).Reversed()}
...
// checkCity311ConstituentConstraints performs lookups (on valid) resource to check if any of the values on unique fields
// already exists in the store
//
// Using built-in constraint checking would be more performant, but unfortunately we cannot rely
// on the full support (MySQL does not support conditional indexes)
//
// This function is auto-generated
func (s *Store) checkCity311ConstituentConstraints(ctx context.Context, res *composeType.City311Constituent) (err error) {
	err = func() (err error) {

		// handling string type as default
		if len(res.ConstituentID) == 0 {
			// skip check on empty values
			return nil
		}

		ex, err := s.LookupCity311ConstituentByConstituentID(ctx, res.ConstituentID)
		if err == nil && ex != nil && ex.ID != res.ID {
			return store.ErrNotUnique.Stack(1)
		} else if !errors.IsNotFound(err) {
			return err
...
// DeleteRoleMemberByResourceRoleID deletes single entry from roleMember collection
//
// This function is auto-generated
func (s *Store) DeleteRoleMemberByResourceRoleID(ctx context.Context, resource string, roleID uint64) error {
	return s.Exec(ctx, roleMemberDeleteQuery(s.Dialect.GOQU(), goqu.Ex{
		"rel_resource": resource,
		"rel_role":     roleID,
	}))
}
...
// CreateUserGroup creates one or more rows in userGroup collection
//
// This function is auto-generated
func (s *Store) CreateUserGroup(ctx context.Context, rr ...*systemType.UserGroup) (err error) {
	for i := range rr {
		...
		if err = s.Exec(ctx, userGroupInsertQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpdateUserGroup updates one or more existing entries in userGroup collection
//
// This function is auto-generated
func (s *Store) UpdateUserGroup(ctx context.Context, rr ...*systemType.UserGroup) (err error) {
	for i := range rr {
		if err = s.checkUserGroupConstraints(ctx, rr[i]); err != nil {
			return
		}
...
// UpsertUserGroup updates one or more existing entries in userGroup collection
//
// This function is auto-generated
func (s *Store) UpsertUserGroup(ctx context.Context, rr ...*systemType.UserGroup) (err error) {
	for i := range rr {
		if err = s.checkUserGroupConstraints(ctx, rr[i]); err != nil {
			return
		}
		...
		if s.Dialect.Nuances().TwoStepUpsert {
			var rsp sql.Result
			rsp, err = s.ExecR(ctx, userGroupUpdateQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
			if c, err := rsp.RowsAffected(); err != nil {
			...
			err = s.Exec(ctx, userGroupInsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		} else {
			err = s.Exec(ctx, userGroupUpsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		}
...
// DeleteUserGroup Deletes one or more entries from userGroup collection
//
// This function is auto-generated
...
// DeleteUserGroupByID deletes single entry from userGroup collection
//
// This function is auto-generated
...
// SearchUserGroups returns (filtered) set of UserGroups
//
// This function is auto-generated
func (s *Store) SearchUserGroups(ctx context.Context, f systemType.UserGroupFilter) (set systemType.UserGroupSet, _ systemType.UserGroupFilter, err error) {
	...
	// Cloned sorting instructions for the actual sorting
	// Original are passed to the etchFullPageOfUserGroups fn used for cursor creation;
	// direction information it MUST keep the initial
	sort := f.Sort.Clone()
	...
	set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfUserGroups(ctx, f, sort)
...
// fetchFullPageOfUserGroups collects all requested results.
//
// Function applies:
//   - cursor conditions (where ...)
//   - limit
...
//
// This function is auto-generated
func (s *Store) fetchFullPageOfUserGroups(
	ctx context.Context,
	filter systemType.UserGroupFilter,
	sort filter.SortExprSet,
) (set []*systemType.UserGroup, prev, next *filter.PagingCursor, err error) {
	var (
		aux []*systemType.UserGroup
	...
	if hasPrev {
		prev = s.collectUserGroupCursorValues(set[0], filter.Sort...)
		prev.ROrder = true
		prev.LThen = !filter.Sort.Reversed()
	}

	if hasNext {
		next = s.collectUserGroupCursorValues(set[collected-1], filter.Sort...)
		next.LThen = filter.Sort.Reversed()
	}
...
func (s *Store) QueryUserGroups(
	...
	if s.Filters.UserGroup != nil {
		// extended filter set
		tExpr, f, err = s.Filters.UserGroup(s, f)
	} else {
		// using generated filter
		tExpr, f, err = UserGroupFilter(s.Dialect, f)
	}

	if err != nil {
		err = fmt.Errorf("could not generate filter expression for UserGroup: %w", err)
		return
	}
	...
	rows, err = s.Query(ctx, query)
	if err != nil {
		err = fmt.Errorf("could not query UserGroup: %w", err)
		return
	}
	...
	for rows.Next() {
		...
		if err = aux.scan(rows); err != nil {
			err = fmt.Errorf("could not scan rows for UserGroup: %w", err)
			return
		}

		count++
		if res, err = aux.decode(); err != nil {
			err = fmt.Errorf("could not decode UserGroup: %w", err)
			return
		}
...
//
// This function is auto-generated
func (Store) sortableUserGroupFields() map[string]string {
	return map[string]string{
		"archived_at": "archived_at",
		"archivedat":  "archived_at",
		"created_at":  "created_at",
...
// collectUserGroupCursorValues collects values from the given resource that and sets them to the cursor
// to be used for pagination
//
// Values that are collected must come from sortable, unique or primary columns/fields
// At least one of the collected columns must be flagged as unique, otherwise fn appends primary keys at the end
...
//
// This function is auto-generated
func (s *Store) collectUserGroupCursorValues(res *systemType.UserGroup, cc ...*filter.SortExpr) *filter.PagingCursor {
	var (
		cur = &filter.PagingCursor{LThen: filter.SortExprSet(cc).Reversed()}
...
// checkUserGroupConstraints performs lookups (on valid) resource to check if any of the values on unique fields
// already exists in the store
//
// Using built-in constraint checking would be more performant, but unfortunately we cannot rely
// on the full support (MySQL does not support conditional indexes)
//
// This function is auto-generated
func (s *Store) checkUserGroupConstraints(ctx context.Context, res *systemType.UserGroup) (err error) {
	err = func() (err error) {
