...
// CreateLlmProvider creates one or more rows in llmProvider collection
//
// This function is auto-generated
func (s *Store) CreateLlmProvider(ctx context.Context, rr ...*systemType.LlmProvider) (err error) {
	for i := range rr {
		...
		if err = s.Exec(ctx, llmProviderInsertQuery(s.Dialect.GOQU(), rr[i])); err != nil {
			return
		}
	}
...
// UpdateLlmProvider updates one or more existing entries in llmProvider collection
//
// This function is auto-generated
func (s *Store) UpdateLlmProvider(ctx context.Context, rr ...*systemType.LlmProvider) (err error) {
	for i := range rr {
		if err = s.checkLlmProviderConstraints(ctx, rr[i]); err != nil {
			return
		}
...
// UpsertLlmProvider updates one or more existing entries in llmProvider collection
//
// This function is auto-generated
func (s *Store) UpsertLlmProvider(ctx context.Context, rr ...*systemType.LlmProvider) (err error) {
	for i := range rr {
		if err = s.checkLlmProviderConstraints(ctx, rr[i]); err != nil {
			return
		}
		...
		if s.Dialect.Nuances().TwoStepUpsert {
			var rsp sql.Result
			rsp, err = s.ExecR(ctx, llmProviderUpdateQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
			if c, err := rsp.RowsAffected(); err != nil {
			...
			err = s.Exec(ctx, llmProviderInsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		} else {
			err = s.Exec(ctx, llmProviderUpsertQuery(s.Dialect.GOQU(), rr[i]))
			if err != nil {
				return
			}
		}
...
// DeleteLlmProvider Deletes one or more entries from llmProvider collection
//
// This function is auto-generated
...
// DeleteLlmProviderByID deletes single entry from llmProvider collection
//
// This function is auto-generated
...
// SearchLlmProviders returns (filtered) set of LlmProviders
//
// This function is auto-generated
func (s *Store) SearchLlmProviders(ctx context.Context, f systemType.LlmProviderFilter) (set systemType.LlmProviderSet, _ systemType.LlmProviderFilter, err error) {
	...
	// Cloned sorting instructions for the actual sorting
	// Original are passed to the etchFullPageOfLlmProviders fn used for cursor creation;
	// direction information it MUST keep the initial
	sort := f.Sort.Clone()
	...
	set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfLlmProviders(ctx, f, sort)
...
// fetchFullPageOfLlmProviders collects all requested results.
//
// Function applies:
//   - cursor conditions (where ...)
//   - limit
...
//
// This function is auto-generated
func (s *Store) fetchFullPageOfLlmProviders(
	ctx context.Context,
	filter systemType.LlmProviderFilter,
	sort filter.SortExprSet,
) (set []*systemType.LlmProvider, prev, next *filter.PagingCursor, err error) {
	var (
		aux []*systemType.LlmProvider
	...
	if hasPrev {
		prev = s.collectLlmProviderCursorValues(set[0], filter.Sort...)
		prev.ROrder = true
		prev.LThen = !filter.Sort.Reversed()
	}

	if hasNext {
		next = s.collectLlmProviderCursorValues(set[collected-1], filter.Sort...)
		next.LThen = filter.Sort.Reversed()
	}
...
func (s *Store) QueryLlmProviders(
	...
	if s.Filters.LlmProvider != nil {
		// extended filter set
		tExpr, f, err = s.Filters.LlmProvider(s, f)
	} else {
		// using generated filter
		tExpr, f, err = LlmProviderFilter(s.Dialect, f)
	}

	if err != nil {
		err = fmt.Errorf("could not generate filter expression for LlmProvider: %w", err)
		return
	}
	...
	rows, err = s.Query(ctx, query)
	if err != nil {
		err = fmt.Errorf("could not query LlmProvider: %w", err)
		return
	}
	...
	for rows.Next() {
		...
		if err = aux.scan(rows); err != nil {
			err = fmt.Errorf("could not scan rows for LlmProvider: %w", err)
			return
		}

		count++
		if res, err = aux.decode(); err != nil {
			err = fmt.Errorf("could not decode LlmProvider: %w", err)
			return
		}
...
//
// This function is auto-generated
func (Store) sortableLlmProviderFields() map[string]string {
	return map[string]string{
		"created_at": "created_at",
		"createdat":  "created_at",
		"deleted_at": "deleted_at",
...
// collectLlmProviderCursorValues collects values from the given resource that and sets them to the cursor
// to be used for pagination
//
// Values that are collected must come from sortable, unique or primary columns/fields
// At least one of the collected columns must be flagged as unique, otherwise fn appends primary keys at the end
...
//
// This function is auto-generated
func (s *Store) collectLlmProviderCursorValues(res *systemType.LlmProvider, cc ...*filter.SortExpr) *filter.PagingCursor {
	var (
		cur = &filter.PagingCursor{LThen: filter.SortExprSet(cc).Reversed()}
...
// checkLlmProviderConstraints performs lookups (on valid) resource to check if any of the values on unique fields
// already exists in the store
//
// Using built-in constraint checking would be more performant, but unfortunately we cannot rely
// on the full support (MySQL does not support conditional indexes)
//
// This function is auto-generated
func (s *Store) checkLlmProviderConstraints(ctx context.Context, res *systemType.LlmProvider) (err error) {
	err = func() (err error) {
