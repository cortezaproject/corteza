...
type (
	...
	AiConversationAPI interface {
		List(context.Context, *request.AiConversationList) (interface{}, error)
...
func NewAiConversation(h AiConversationAPI) *AiConversation {
	return &AiConversation{
		List: func(w http.ResponseWriter, r *http.Request) {
			defer r.Body.Close()
			params := request.NewAiConversationList()
		...
		Read: func(w http.ResponseWriter, r *http.Request) {
			defer r.Body.Close()
			params := request.NewAiConversationRead()
			if err := params.Fill(r); err != nil {
				api.Send(w, r, err)
				return
			}
		...
		Delete: func(w http.ResponseWriter, r *http.Request) {
			defer r.Body.Close()
			params := request.NewAiConversationDelete()
			if err := params.Fill(r); err != nil {
				api.Send(w, r, err)
				return
			}
		...
		Undelete: func(w http.ResponseWriter, r *http.Request) {
			defer r.Body.Close()
			params := request.NewAiConversationUndelete()
			if err := params.Fill(r); err != nil {
				api.Send(w, r, err)
				return
			}
...
func (h AiConversation) MountRoutes(r chi.Router, middlewares ...func(http.Handler) http.Handler) {
	r.Group(func(r chi.Router) {
		r.Use(middlewares...)
		r.Get("/ai-conversations/", h.List)
