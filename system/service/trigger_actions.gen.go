...
// system/service/trigger_actions.yaml
...
// TriggerErrNotAllowedToList returns "system:trigger.notAllowedToList" as *errors.Error
//
//
// This function is auto-generated.
//
func TriggerErrNotAllowedToList(mm ...*triggerActionProps) *errors.Error {
	var p = &triggerActionProps{}
	if len(mm) > 0 {
		p = mm[0]
	}
	...
	var e = errors.New(
		...
		p.Format("not allowed to list triggers", nil),
