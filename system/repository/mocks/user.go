...
func (m *MockUserRepository) UndeleteByID(id uint64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UndeleteByID", id)
	ret0, _ := ret[0].(error)
	return ret0
}

// UndeleteByID indicates an expected call of UndeleteByID
func (mr *MockUserRepositoryMockRecorder) UndeleteByID(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
