...
const constituent: Constituent = {
  ...
  phone_numbers: [{ label: 'MOBILE', value: '+15550100' }],
  addresses: [{
...
const roleDefinitions: Record<ApplicationRole, RoleDefinition> = {
  ...
  constituent: {
    ...
    departments: [],
    districts: ['NORTH'],
    capabilities: ['portal_my_requests', 'portal_reopen_request', 'portal_link_anonymous_request', 'portal_draft_create', 'portal_draft_get', 'portal_draft_update', 'portal_draft_delete', 'portal_draft_submit', 'attachment_download', 'profile_get', 'profile_update', 'password_change', 'login_identifier_change', 'security_notification_get'],
    scopes: ['service_requests.write'],
    routes: ['session_current', 'portal_my_requests', 'portal_service_request_submit', 'portal_draft_create', 'portal_draft_get', 'portal_draft_update', 'portal_draft_delete', 'portal_draft_submit', 'portal_attachment_upload', 'portal_reopen_request', 'portal_link_anonymous_request', 'attachment_download', 'profile_get', 'profile_update', 'password_change', 'login_identifier_change', 'security_notification_get'],
  ...
  return {
    ...
    session: {
      ...
      actor: {
        ...
        capabilities: ['portal_my_requests', 'portal_draft_create', 'portal_draft_get', 'portal_draft_update', 'portal_draft_delete', 'portal_draft_submit', 'attachment_download', 'security_notification_get'],
        scopes: ['service_requests.write'],
        available_routes: ['session_current', 'portal_my_requests', 'portal_service_request_submit', 'portal_draft_create', 'portal_draft_get', 'portal_draft_update', 'portal_draft_delete', 'portal_draft_submit', 'portal_attachment_upload', 'attachment_download', 'security_notification_get'],
      },
      preferred_language: 'EN',
    ...
    errors: {
      ...
      'idempotency-conflict': { error: 'IDEMPOTENCY_CONFLICT', message: 'The idempotency key has already been used with different content.', retryable: false },
      'expected-version-required': { error: 'EXPECTED_VERSION_REQUIRED', message: 'An expected version is required for this operation.', retryable: false },
