...
export class PageBlockRecord extends PageBlock {
  ...
  applyOptions (o?: Partial<Options>): void {
    ...
    Apply(this.options, o, Boolean, 'inlineRecordEditEnabled', 'horizontalFieldLayoutEnabled', 'horizontalEditingMode', 'wrapFields')
