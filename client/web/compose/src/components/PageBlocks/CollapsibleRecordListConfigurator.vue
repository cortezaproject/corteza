<template>
  ...
  >
    ...
    >
      <h5 class="mb-3">
        {{ $t('ccollapsibleRecord.bodySection.label') }}
      </h5>
    ...
    <div class="px-3">
      <h5 class="mb-3">
        {{ $t('collapsibleRecord.collapseSection') }}
      </h5>

      <p class="text-muted">
        {{ $t('collapsibleRecord.collapseSectionAlwaysCollapsed') }}
      </p>
    </div>
...
export default {
  ...
  computed: {
    ...
    positionOptions () {
      return [
        { value: 'default', label: this.$t('collapsibleRecord.positionDefault') },
        { value: 'above', label: this.$t('collapsibleRecord.positionAbove') },
        { value: 'below', label: this.$t('collapsibleRecord.positionBelow') },
      ]
    },
