...
func (s Store) SearchComposePages(ctx context.Context, f types.PageFilter) (types.PageSet, types.PageFilter, error) {
	...
	return set, f, func() error {
		...
		set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfComposePages(ctx, q, sort.Columns(), sort.Reversed(), f.PageCursor, f.Limit, f.Check)
		if err != nil {
			return err
		}
