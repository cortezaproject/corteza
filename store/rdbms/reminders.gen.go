...
func (s Store) SearchReminders(ctx context.Context, f types.ReminderFilter) (types.ReminderSet, types.ReminderFilter, error) {
	...
	return set, f, func() error {
		...
		set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfReminders(ctx, q, sort.Columns(), sort.Reversed(), f.PageCursor, f.Limit, f.Check)
		if err != nil {
			return err
		}
