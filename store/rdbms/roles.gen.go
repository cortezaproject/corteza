...
func (s Store) SearchRoles(ctx context.Context, f types.RoleFilter) (types.RoleSet, types.RoleFilter, error) {
	...
	return set, f, func() error {
		...
		set, f.PrevPage, f.NextPage, err = s.fetchFullPageOfRoles(ctx, q, sort.Columns(), sort.Reversed(), f.PageCursor, f.Limit, f.Check)
		if err != nil {
			return err
		}
